 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/RippleGrid/RippleGrid.tsx
...
void main() {
    ...
    if (mouseInteraction) {
      ...
      containerRef.current.addEventListener('pointerenter', handleMouseEnter);
    ...
    return () => {
      ...
      if (mouseInteraction && containerRef.current) {
        ...
        containerRef.current.removeEventListener('pointerenter', handleMouseEnter);
  ...
  return (
    <div ref={containerRef} className="ripple-grid-container" role="img" aria-label="Ripple Grid" />
  );
};
