 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/LetterGlitch/LetterGlitch.tsx
 ...
 *
 * Local changes:
 * 1. paused, onReady, and onError props so the story can hold the glitch and prove paint.
 * 2. Import CSSProperties so the file type-checks without a React namespace.
 * 3. Letters render in Brand Sans.
 */
...
const LetterGlitch = ({
  ...
  const drawLetters = () => {
    ...
    ctx.font = `${fontSize}px 'Brand Sans', Arial, sans-serif`;
  ...
  return (
    <div style={containerStyle as CSSProperties} className={className}>
