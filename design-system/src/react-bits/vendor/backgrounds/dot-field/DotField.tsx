 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/DotField/DotField.tsx
 ...
 *
 * Local changes:
 * 1. paused, onReady, and onError props so the story can hold the field and prove paint.
 * 2. Pointer listeners on the container, not window.
 */
        ...
        if (!pausedRef.current) {
          if (distSq < crSq && eng > 0.01) {
            ...
            if (isBulge) {
              ...
              const push = pushT * pushT * (p.bulgeStrength as number) * eng;
