 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/LineWaves/LineWaves.tsx
...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    try {
      renderer = new Renderer({ alpha: true, premultipliedAlpha: false, preserveDrawingBuffer: true });
    } catch {
