 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/EvilEye/EvilEye.tsx
  ...
  useEffect(() => {
    ...
    function update(time: number) {
      ...
      if (!pausedRef.current) {
        if (lastT) elapsed += (time - lastT) * 0.001;
