 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/Grainient/Grainient.tsx
 * Page: https://reactbits.dev/backgrounds/grainient
...
const Grainient: React.FC<GrainientProps> = ({
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      lastT = t;
      (program.uniforms.iTime as { value: number }).value = elapsed * 0.001;
      renderer.render({ scene: mesh });
      if (!notifiedReady) {
        notifiedReady = true;
