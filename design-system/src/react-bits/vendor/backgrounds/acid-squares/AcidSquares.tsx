 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/AcidSquares/AcidSquares.tsx
...
const AcidSquares: React.FC<AcidSquaresProps> = ({
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      if (!pausedRef.current) elapsed += (t - lastT) * 0.001;
      lastT = t;
