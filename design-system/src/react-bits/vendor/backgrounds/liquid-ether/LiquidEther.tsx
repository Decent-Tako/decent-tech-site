  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        ...
        this.listenerTarget.addEventListener('mouseleave', this._onDocumentLeave);
      }
      dispose() {
        ...
        if (this.listenerTarget) {
          this.listenerTarget.removeEventListener('mouseleave', this._onDocumentLeave);
        }
