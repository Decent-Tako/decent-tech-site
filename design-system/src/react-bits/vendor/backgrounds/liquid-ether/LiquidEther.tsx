 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/LiquidEther/LiquidEther.tsx
 ...
 * Local changes:
 * 1. This header.
 * 2. `paused` prop. `pause()` stops the frame loop and `start()` resumes it.
 *    The visibility and intersection handlers do not restart a paused loop.
 *    A sketch that mounts paused renders one frame and stops.
...
`;
    ...
    if (pausedRef.current) webgl.render();
    else webgl.start();
