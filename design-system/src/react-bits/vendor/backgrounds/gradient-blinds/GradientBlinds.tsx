 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/GradientBlinds/GradientBlinds.tsx
 ...
 * 3. Pause reads a props ref, so it does not remount the sketch.
 */
...
const GradientBlinds: React.FC<GradientBlindsProps> = ({
  ...
  const propsRef = useRef<GradientBlindsProps>(props);
