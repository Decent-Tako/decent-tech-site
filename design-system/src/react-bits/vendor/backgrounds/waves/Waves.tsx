 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/Waves/Waves.tsx
 ...
 *
 * Local changes:
 * 1. paused and onReady props so the story can hold the lines and prove paint.
 * 2. Advance the lines for 12 frames before Pause holds, so a still frame has paint.
 ...
 * 5. Add role="img" and aria-label so a11y accepts the labelled stage.
 */
...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function tick(t: number) {
      ...
      const WARM = 12;
      const hold = pausedRef.current && framesRef.current >= WARM;
      if (!hold) {
