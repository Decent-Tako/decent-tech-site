 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/Galaxy/Galaxy.tsx
 ...
 * 4. The `focal` and `rotation` defaults are module constants. The inline
 *    array literals were new values on every render, so the effect rebuilt
 *    the renderer each time.
...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    drawOnceRef.current = () => {
      if (hasDrawn) renderer.render({ scene: mesh });
    };
    animateId = requestAnimationFrame(update);
