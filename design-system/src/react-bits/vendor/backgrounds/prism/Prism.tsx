 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/Prism/Prism.tsx
 ...
 * 4. Bind pointermove to the container, not window, so play can drive hover.
 */
...
const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const onMove = (e: PointerEvent) => {
      ...
      const wh = Math.max(1, rect.height);
      const cx = rect.left + ww * 0.5;
      const cy = rect.top + wh * 0.5;
  ...
  return <div className="prism-container" ref={containerRef} role="img" aria-label="Prism" />;
};
