 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/GridScan/GridScan.tsx
 ...
 * 3. Load face-api models only when enableWebcam is true, so the story does not fetch a CDN.
 */
...
export const GridScan: React.FC<GridScanProps> = ({
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const dt = pausedRef.current ? 0 : Math.max(0, Math.min(0.1, (now - last) / 1000));
      last = now;
