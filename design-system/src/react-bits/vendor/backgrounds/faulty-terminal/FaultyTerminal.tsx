 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/FaultyTerminal/FaultyTerminal.tsx
 ...
 * 2. onReady and onError props so the story can prove paint or the fallback.
 * 3. pause is read from a ref so the Pause button does not remount the sketch.
 */
...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    try {
      renderer = new Renderer({ dpr, preserveDrawingBuffer: true });
    } catch {
      onErrorRef.current?.();
      return;
    }
