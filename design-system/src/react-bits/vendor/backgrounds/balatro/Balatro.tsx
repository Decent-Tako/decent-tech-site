 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/Balatro/Balatro.tsx
 ...
 * 3. Pointer listeners on the container (pointermove), not window.
 */
...
export default function Balatro({
  ...
  useEffect(() => {
    ...
    try {
      renderer = new Renderer({ preserveDrawingBuffer: true });
    } catch {
      onErrorRef.current?.();
      return;
    }
