 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/GridDistortion/GridDistortion.tsx
 ...
 * 3. Try/catch around WebGLRenderer so a missing context does not throw.
 */
...
const GridDistortion = ({
  ...
  const propsRef = useRef({ paused, onReady, onError });
  propsRef.current = { paused, onReady, onError };
