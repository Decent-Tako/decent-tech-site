 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/AeroShards/AeroShards.tsx
 ...
 *
 * Local changes:
 * 1. GPUTextureFormat cast so TypeScript accepts the canvas format string.
 * 2. onReady fires after the first frame so the story can prove paint.
 * 3. Pointer listeners on the root element, not window.
 */
...
export default function AeroShards({
  ...
  const onReadyRef = useRef<AeroShardsProps['onReady']>(onReady);
  ...
  useEffect(() => {
    ...
    root.addEventListener('pointercancel', deactivatePointer, { passive: true });
