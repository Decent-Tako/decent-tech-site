 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/Lightfall/Lightfall.tsx
 ...
 * 2. onReady and onError props so the story can prove paint. paused stays a
 *    ref so Pause does not remount the sketch.
 */
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      if (!pausedRef.current) {
        if (lastTick) elapsed += t - lastTick;
      }
      lastTick = t;
