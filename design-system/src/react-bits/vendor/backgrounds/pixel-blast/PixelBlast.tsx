 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Backgrounds/PixelBlast/PixelBlast.tsx
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        if (!hold) {
          if (lastT) simTime += (now - lastT) * 0.001;
          frames += 1;
        }
        lastT = now;
        uniforms.uTime.value = timeOffset + simTime * speedRef.current;
        if (liquidEffect) {
