 ...
 * 4. Listen for pointermove as well as mousemove so play can drive the pointer.
 * 5. Prefix unused buildFragment argument so TypeScript noUnusedParameters passes.
 */
...
export const Plasma: React.FC<PlasmaProps> = ({
  ...
  useEffect(() => {
    ...
    if (mouseInteractive) {
      ...
      containerEl.addEventListener('pointermove', handleMouseMove, { passive: true });
    }
    ...
    return () => {
      ...
      if (mouseInteractive && containerEl) {
        ...
        containerEl.removeEventListener('pointermove', handleMouseMove);
      }
      try {
