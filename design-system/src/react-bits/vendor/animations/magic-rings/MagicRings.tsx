 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/MagicRings/MagicRings.tsx
...
export default function MagicRings({
  ...
  useEffect(() => {
    ...
    renderer.domElement.setAttribute('data-testid', 'magic-rings-canvas');
    ...
    const onPointerEnter = () => { isHoveredRef.current = true; };
