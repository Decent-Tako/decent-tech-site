 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/LaserFlow/LaserFlow.tsx
...
export const LaserFlow: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    canvas.setAttribute('data-testid', 'laser-flow-canvas');
