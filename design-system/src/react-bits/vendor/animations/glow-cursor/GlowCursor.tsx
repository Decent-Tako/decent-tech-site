 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/GlowCursor/GlowCursor.tsx
 ...
 *
 * Local changes:
 * 1. paused skips trail updates and keeps the last frame.
 * 2. preserveDrawingBuffer is true so the story can sample pixels.
 * 3. onReady fires after the first draw.
 * 4. data-testid on the host and the canvas.
 */
...
const GlowCursor = ({
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      if (initialized && !pausedRef.current) {
  ...
  return (
    ...
    >
      <canvas
        ...
        data-testid="glow-cursor-canvas"
