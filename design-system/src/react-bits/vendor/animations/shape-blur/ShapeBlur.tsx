 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/ShapeBlur/ShapeBlur.tsx
 ...
 * 2. paused skips mouse damping and keeps the last frame.
 * 3. seedCenter places the pointer at the middle so the shape is visible.
 * 4. onReady fires after the first draw. onUnavailable fires when WebGL is missing.
 * 5. data-testid on the canvas. Pointer listeners sit on the host, not document.
 */
...
const ShapeBlur = ({
  ...
  useEffect(() => {
    ...
    renderer.domElement.setAttribute('data-testid', 'shape-blur-canvas');
