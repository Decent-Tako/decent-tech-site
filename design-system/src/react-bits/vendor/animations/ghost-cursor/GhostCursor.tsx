 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/GhostCursor/GhostCursor.tsx
 ...
 * 4. data-testid ghost-cursor-canvas on the canvas.
 */
...
const GhostCursor: React.FC<GhostCursorProps> = ({
  ...
  useEffect(() => {
    ...
    renderer.domElement.setAttribute('data-testid', 'ghost-cursor-canvas');
