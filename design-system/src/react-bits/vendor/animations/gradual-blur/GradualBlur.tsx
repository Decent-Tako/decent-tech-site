 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/GradualBlur/GradualBlur.tsx
 ...
 *
 * Local changes:
 * 1. paused skips hover intensity.
 * 2. data-testid gradual-blur-overlay on the host.
 */
...
const GradualBlur: React.FC<PropsWithChildren<GradualBlurProps>> = ({ paused = false, ...props }) => {
  ...
  return (
    <div
      ...
      data-testid="gradual-blur-overlay"
      data-div-count={String(config.divCount)}
      style={containerStyle}
      onMouseEnter={
        hoverIntensity
          ? () => {
              if (!pausedRef.current) setIsHovered(true);
            }
          : undefined
      }
