 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/Cubes/Cubes.tsx
 ...
 *
 * Local changes:
 * 1. paused skips pointer tilt, click ripples, and the auto-animate loop.
 * 2. onRipple reports a click burst. data-testid on the scene.
 */
...
const Cubes: React.FC<CubesProps> = ({
  ...
  const onClick = useCallback(
    (e: MouseEvent | TouchEvent) => {
      ...
      onRippleRef.current?.(rippleCountRef.current);
    },
  ...
  useEffect(() => {
    ...
    const speed = 0.02;
    const loop = () => {
      if (!pausedRef.current && !userActiveRef.current) {
  ...
  return (
    <div className="default-animation" style={wrapperStyle}>
      <div ref={sceneRef} className="default-animation--scene" data-testid="cubes-scene" style={sceneStyle}>
        {cells.map((_, r) =>
          cells.map((__, c) => (
