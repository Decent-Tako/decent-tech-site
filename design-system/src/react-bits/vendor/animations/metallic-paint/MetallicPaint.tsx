 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/MetallicPaint/MetallicPaint.tsx
 ...
 * 3. onReady fires after the first draw. onUnavailable fires when WebGL 2 or the image is missing.
...
export default function MetallicPaint({
  ...
  const initGL = useCallback(() => {
    ...
    if (!gl) return false;
    canvas.setAttribute('data-testid', 'metallic-paint-canvas');
