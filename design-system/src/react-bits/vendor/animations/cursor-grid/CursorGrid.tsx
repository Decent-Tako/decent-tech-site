 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/CursorGrid/CursorGrid.tsx
 ...
 *
 * Local changes:
 * 1. paused skips pointer energize and click pulses.
 * 2. data-testid on the canvas.
 */
...
const CursorGrid = ({
  ...
  return (
    <div ref={containerRef} className={`cursor-grid${className ? ` ${className}` : ''}`}>
      <canvas ref={canvasRef} className="cursor-grid__canvas" data-testid="cursor-grid-canvas" />
    </div>
  );
};
