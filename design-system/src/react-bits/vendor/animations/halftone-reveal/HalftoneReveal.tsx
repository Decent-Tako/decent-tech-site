 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/HalftoneReveal/HalftoneReveal.tsx
 ...
 * 5. Import CSSProperties as a type for verbatimModuleSyntax.
 */
...
const HalftoneReveal = ({
  ...
  useEffect(() => {
    ...
    gl.canvas.setAttribute('data-testid', 'halftone-reveal-canvas');
