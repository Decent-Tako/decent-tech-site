 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/Strands/Strands.tsx
 ...
 *    time step and the render while `paused` is true, after the first frame
 *    has drawn.
 * 3. `onReady` prop. Called once, after the first rendered frame.
 * 4. The renderer `dpr` is `min(devicePixelRatio, 2)`. Upstream used the
 *    library default.
...
export default function Strands({
  ...
  const propsRef = useRef<Required<Omit<StrandsProps, 'className' | 'style' | 'paused' | 'onReady'>>>({
    colors,
    count,
    speed,
    amplitude,
