 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/SwarmCursor/SwarmCursor.tsx
 ...
 *    physics step and the field render while `paused` is true, after the
...
const SwarmCursor = ({
  ...
  useEffect(() => {
    ...
    const frame = (now: number) => {
      ...
      if (hasDrawn && (pausedRef.current || !p.enabled || reduceMotion)) {
        return;
      }
