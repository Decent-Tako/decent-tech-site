 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/PixelTransition/PixelTransition.tsx
 ...
 *
 * Local changes:
 * 1. paused skips new swaps and keeps the last frame.
 * 2. reduced swaps to the second content at once with no gsap.
 * 3. onActive reports the visible side. data-testid and data-active on the host.
 */
...
const PixelTransition: React.FC<PixelTransitionProps> = ({
  ...
  const [isActive, setIsActive] = useState<boolean>(reduced);
  ...
  return (
    <div
      ...
      style={style}
      data-testid="pixel-transition-card"
