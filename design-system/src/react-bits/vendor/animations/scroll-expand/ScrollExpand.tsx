 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Animations/ScrollExpand/ScrollExpand.tsx
...
const ScrollExpand: React.FC<ScrollExpandProps> = ({
  ...
  const applyProgress = useCallback((p: number) => {
    ...
    if (rootRef.current) {
      rootRef.current.dataset.progress = p.toFixed(3);
    }
