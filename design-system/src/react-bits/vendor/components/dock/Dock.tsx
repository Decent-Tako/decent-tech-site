 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/Dock/Dock.tsx
...
export default function Dock({
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="dock-outer">
      <motion.div
        onPointerMove={event => followPointer(event.clientX)}
        onPointerLeave={rest}
