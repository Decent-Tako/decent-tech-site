 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/MorphSlider/MorphSlider.tsx
 ...
 *
 * Local changes:
 * 1. Unused indicator map parameter renamed so TypeScript accepts the file.
 * 2. preserveDrawingBuffer is on so play can sample the canvas.
 * 3. paused holds the rAF loop. reducedMotion and onReady are props.
 * 4. onIndexChange reports the active slide to the wrapper.
 */
...
export default function MorphSlider({
  ...
  }, [items, startIndex, reducedMotion]);
