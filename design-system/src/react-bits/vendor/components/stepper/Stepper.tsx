 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/Stepper/Stepper.tsx
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#212121', color: '#FFFFFF' },
          active: { scale: 1, backgroundColor: '#0035B1', color: '#0035B1' },
          complete: { scale: 1, backgroundColor: '#0035B1', color: '#FFFFFF' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: '#0035B1' }
  };
