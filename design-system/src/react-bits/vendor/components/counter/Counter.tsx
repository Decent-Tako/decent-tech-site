 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/Counter/Counter.tsx
 ...
 *
 * Local changes:
 * 1. paused skips spring.set so Pause can freeze the digit reels.
 */
...
function Digit({ place, value, height, digitStyle, paused = false }: DigitProps) {
  if (place === '.') {
    return (
  ...
  }, [animatedValue, valueRoundedToPlace, paused]);
