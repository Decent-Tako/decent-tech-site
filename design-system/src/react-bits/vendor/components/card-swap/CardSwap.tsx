 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/CardSwap/CardSwap.tsx
 ...
 *
 * Local changes:
 * 1. paused freezes the swap timeline and clears the interval.
 * 2. onSwap reports the front card so the story can assert the cycle.
 */
import React, {
  Children,
  cloneElement,
  ...
  useEffect(() => {
    ...
    const swap = () => {
      ...
      tl.call(() => {
        ...
        onSwapRef.current?.(rest[0] ?? front);
      });
    };
