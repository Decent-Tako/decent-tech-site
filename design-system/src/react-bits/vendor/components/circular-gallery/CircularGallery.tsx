 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/CircularGallery/CircularGallery.tsx
 ...
 * 2. paused, onReady, onError, and onScroll so the story can hold the orbit and prove paint.
 * 3. Pointer, wheel, and resize listeners on the container, not window.
 * 4. Default font is Brand Sans. The component does not fetch Google Fonts.
 * 5. No remote default photographs. The wrapper supplies Academy photos.
 */
...
const DEFAULT_FONT = '700 30px "Brand Sans", Arial, sans-serif';
...
async function resolveFont(font: string, fontUrl?: string): Promise<string> {
  // Do not fetch a remote face. Brand Sans is already on the page.
