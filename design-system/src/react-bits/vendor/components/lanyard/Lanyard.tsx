 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/Lanyard/Lanyard.tsx
 ...
 *
 * Local changes:
 * 1. Import @react-three/fiber, @react-three/drei, and @react-three/rapier
 *    through local JS re-exports. Direct types overwrite React JSX.
 * 2. // @ts-nocheck: the re-export types are `any`.
 * 3. card.glb and lanyard.png load through import.meta.url.
 * 4. preserveDrawingBuffer, paused, and onReady so the story can prove paint.
 */
// @ts-nocheck
/* eslint-disable react/no-unknown-property */
'use client';
import { useEffect, useMemo, useRef, useState } from 'react';
import { Canvas, extend, useFrame } from './fiber-runtime.js';
import { useGLTF, useTexture, Environment, Lightformer } from './drei-runtime.js';
import {
  BallCollider,
  CuboidCollider,
  Physics,
