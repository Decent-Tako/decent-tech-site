 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/Stack/Stack.tsx
 ...
 * Local changes:
 * 1. This header.
 * 2. `paused` prop. Autoplay stops while paused.
 * 3. `disableDrag` prop. Reduced motion turns drag off.
 * 4. `onTopChange` reports the top card id after each send-to-back.
...
export default function Stack({
  ...
  }, [autoplay, autoplayDelay, stack, isPaused, paused]);
