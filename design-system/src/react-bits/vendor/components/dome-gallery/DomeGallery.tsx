 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/DomeGallery/DomeGallery.tsx
...
export default function DomeGallery({
  ...
  const applyTransform = (xDeg: number, yDeg: number) => {
    ...
    onRotateRef.current?.({ x: xDeg, y: yDeg });
  };
