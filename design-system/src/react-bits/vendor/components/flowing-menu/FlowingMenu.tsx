 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/Components/FlowingMenu/FlowingMenu.tsx
 ...
 *
 * Local changes:
 * 1. paused pauses the marquee tween.
 * 2. onHover writes the active label so the story can prove mouse enter.
 */
...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  useEffect(() => {
    const calculateRepetitions = () => {
      ...
      const viewportWidth = itemRef.current?.offsetWidth || window.innerWidth;
  ...
  useEffect(() => {
    const setupMarquee = () => {
      ...
      animationRef.current.paused(pausedRef.current);
    };
  ...
  useEffect(() => {
    ...
    animationRef.current.paused(paused);
  }, [paused]);
