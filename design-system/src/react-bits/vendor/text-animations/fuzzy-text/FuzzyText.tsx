 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/TextAnimations/FuzzyText/FuzzyText.tsx
 ...
 * 3. `reduced` draws one unfuzzed frame.
 * 4. `onReady` fires after the first paint.
 * 5. The canvas carries data-testid="fuzzy-text-canvas".
...
const FuzzyText = ({
  ...
  return <canvas ref={canvasRef} className={className} data-testid="fuzzy-text-canvas" />;
};
