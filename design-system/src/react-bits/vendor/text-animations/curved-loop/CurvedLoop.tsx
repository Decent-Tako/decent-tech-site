 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/TextAnimations/CurvedLoop/CurvedLoop.tsx
 ...
 * Local changes:
 * 1. This header.
 * 2. `paused` holds the offset. A ref reads it so Pause does not restart the loop.
 */
...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  useEffect(() => {
    ...
    let frame = 0;
    const step = () => {
      if (!pausedRef.current && !dragRef.current && textPathRef.current) {
  ...
  return (
    <div
      ...
      data-testid="curved-loop-jacket"
