 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/TextAnimations/Shuffle/Shuffle.tsx
 ...
 * 3. `reduced` skips the split and shows the final word.
...
const Shuffle = ({
  ...
  useGSAP(
    () => {
      ...
      if (
        reduced ||
        (respectReducedMotion && window.matchMedia && window.matchMedia('(prefers-reduced-motion: reduce)').matches)
      ) {
        setReady(true);
        onShuffleComplete?.();
        return;
