 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/TextAnimations/StrokeText/StrokeText.tsx
 ...
 * 3. `reduced` shows the finished stroke and fill.
 * 4. `onComplete` reports when the draw finishes.
 * 5. Brand Sans is set on the SVG text. The repository cannot load a remote face.
 * 6. The host carries data-testid="stroke-text-copy".
...
const StrokeText = ({
  ...
  }, [box, dash, drawDuration, fillDelay, stagger, ease, trigger, fillMode, reverse, reduced]);
