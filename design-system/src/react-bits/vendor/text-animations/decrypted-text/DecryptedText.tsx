 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/TextAnimations/DecryptedText/DecryptedText.tsx
 ...
 * Local changes:
 * 1. This header.
 * 2. `paused` clears the scramble interval. `onAnimatingChange` reports
...
export default function DecryptedText({
  ...
  /* Click Behaviour */
  const handleClick = () => {
    if (animateOn !== 'click' || paused) return;
