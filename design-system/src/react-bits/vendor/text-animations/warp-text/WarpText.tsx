 ...
 * Source: https://github.com/DavidHDev/react-bits/blob/625f25025fed1c28e2de7d3ac5f12ee83542844d/src/ts-default/TextAnimations/WarpText/WarpText.tsx
 ...
 * 3. paused holds the frame loop. reduced sets uMotion to 0.
 * 4. onReady, onError, and onPointer so the story can prove paint and pointer.
 * 5. The host carries data-testid="warp-text-copy". The canvas carries
 *    data-testid="warp-text-canvas".
 */
...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    canvas.setAttribute('data-testid', 'warp-text-canvas');
    ...
    const loop = (now: number): void => {
      ...
      const motionOff = reducedRef.current || reduceMotion;
      ...
      onPointerRef.current?.(pointer.x, pointer.y);
